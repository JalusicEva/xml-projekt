...
<nav class="navbar navbar-expand-lg bg-body-tertiary border-bottom border-bottom-dark ">
    <div class="container " >
        <p class="navbar-text">Voditelj - podaci iz tablica Korisnici s djelomičnim pristupom i Skladište s potpunim pristupom</p>
        <div class="d-flex">
...
<div class="container text-center">
        ...
        <caption>ZAPOSLENICI</caption>
            ...
            <tbody class="table-group-divider">
                <?php foreach ($xml->user as $usr):
                    if($usr->razina=="3" || $usr->razina=="2"){
                    ?>
                    <tr>
                        <td><?php echo $usr->ime; ?></td>
                        <td><?php echo $usr->prezime; ?></td>
                        <td><?php echo $usr->naziv_razine; ?></td>
                    </tr>
                <?php }
            endforeach; ?>
            </tbody>
...
?>
        ...
        <table class="table caption-top table-hover">
        <caption>STANJE ARTIKALA</caption>
            <thead>
                <tr>
                    <th>Naziv artikla</th>
                    <th>Šifra</th>
